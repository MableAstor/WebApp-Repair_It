...
export default function FinishedCard({ data, onClickDetail, onDelete }) {
    return (
        <div className="bg-white rounded-3xl p-6 mb-5 shadow-sm w-full flex flex-col relative">
            ...
            <div className="flex flex-col gap-3">
                ...
                <button
                    ...
                    className="w-full bg-red-500 text-white py-3 rounded-2xl font-bold text-[16px] hover:bg-red-600 transition-colors shadow-sm active:scale-95"
                >
                    ลบงาน
                </button>
            </div>
